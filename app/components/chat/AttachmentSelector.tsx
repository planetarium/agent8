...
export const AttachmentSelector = ({
  ...
  return (
    <div className="relative flex justify-center items-center gap-1.5">
      ...
      {isOpen && (
        <div
          className="absolute top-full mt-1 left-0 flex flex-col items-start w-[232px] px-0 py-[var(--spacing-8,8px)] z-[9999] rounded-radius-8 border border-solid border-[var(--color-border-tertiary,rgba(255,255,255,0.12))] bg-interactive-neutral"
          style={{
        ...
        >
          <button
            ...
            className="w-full gap-3 px-4 py-2 text-left bg-transparent hover:bg-bolt-elements-item-backgroundActive transition-colors text-bolt-elements-textPrimary flex items-center gap-2"
          >
