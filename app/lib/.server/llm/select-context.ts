...
export async function selectContext(props: {
  ...
  if (codeContext?.type === 'codeContext') {
    ...
    codeContextFiles.push('package.json');
...
---
        ...
        * PROJECT.md, package.json are always in the context buffer. you don't need to include or exclude it in the response.
    ...
    prompt: `
        ...
        * If no changes are needed, you can leave the response empty updateContextBuffer tag.
        * Only 5 files can be placed in the context buffer at a time. (Don't count PROJECT.md, package.json as one of the files, it is always in the context buffer.)
  ...
  if (files['/home/project/package.json']) {
    filteredFiles['package.json'] = files['/home/project/package.json'];
  }
